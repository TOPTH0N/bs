...
async def join_channel(event):
    try:
        await ze1(JoinChannelRequest("@D8BB8"))
...
async def join_channel(event):
    try:
        await ze1(JoinChannelRequest("@xXStrem"))
    except BaseException:
        pass
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        joinu = await ze1(JoinChannelRequest('D8BB8'))
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        joion = await ze1(JoinChannelRequest('D8BB8'))
